...
public abstract class AbstractKafkaIntegrationTest {
    ...
    @Container
    public static ConfluentKafkaContainer kafka = new ConfluentKafkaContainer(DockerImageName.parse("confluentinc/cp-kafka:7.0.1"));
    ...
    private static void attemptTopicCreation() {
